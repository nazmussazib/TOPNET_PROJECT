...
cor_p2 <- ggplot(DATA2,aes(obs,daymet)) + geom_point(size=6,shape =c(15:22),colour=cbPalette)+
...
X1=data.frame(X=matrix(rbind(t(matrix(DATA2all$model)),t(matrix(DATA2all$model))),nrow=256,ncol=1))
Y1=data.frame(Y=matrix(rbind(t(matrix(DATA2all$model_26_76)),t(matrix(DATA2all$model_85_76))),nrow=256,ncol=1))
name_mod=data.frame(name=matrix(cbind(t(matrix(DATA2all$name)),t(matrix(DATA2all$name))),nrow=256,ncol=1))
ymin=data.frame(ymin=matrix(rbind(t(matrix(DATA2all$ymin)),t(matrix(DATA2all$ymin))),nrow=256,ncol=1))
ymax=data.frame(ymax=matrix(rbind(t(matrix(DATA2all$ymax)),t(matrix(DATA2all$ymax))),nrow=256,ncol=1))
xmin=data.frame(xmin=matrix(rbind(t(matrix(DATA2all$xmin)),t(matrix(DATA2all$xmin))),nrow=256,ncol=1))
xmax=data.frame(xmax=matrix(rbind(t(matrix(DATA2all$xmax)),t(matrix(DATA2all$xmax))),nrow=256,ncol=1))


DATA_all_mod=cbind(X1,Y1,watershed3,name_mod,ymin,ymax,xmin,xmax)
...
s=c(10,6,8,6,6,6,4,4,10,6,8,6,6,6,4,4)
cbPalette_mod=c("white","white","white","white","white","white","white","white","#9999CC", "#E69F00", "#56B4E9", "#009E73", "#F0E442", "#0072B2", "#D55E00", "#CC79A7")


cor_p2 <- ggplot(DATA_all_mod,aes(X,Y)) + geom_point(size=s,shape =p,fill=cbPalette_mod)+geom_abline(intercept = 0)+
...
ggplot(data=df,aes(x=x,y=y,x1=x1,y1=y1,x3=x3,x4=y4,h5=t4,v5=G4,color=factor(facet)))+
  geom_point(aes(shape = factor(facet)),size=6)+ scale_colour_manual(values=c("#9999CC", "#E69F00", "#56B4E9", "#009E73", "#F0E442", "#0072B2", "#D55E00", "#CC79A7"))+
