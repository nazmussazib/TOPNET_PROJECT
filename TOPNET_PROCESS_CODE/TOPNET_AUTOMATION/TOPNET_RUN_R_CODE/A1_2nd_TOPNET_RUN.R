...
setwd("E:/USU_Research_work/TOPNET PROJECT/MODEL COMPARISON/A1_watershed_final_aea_projection/A1_TOPNETRUN")
...
library(hydroPSO)
xe1=(c(0.1,0.1,0.5,0.5,0.1,0.01,0.01,0.01))
xe2=(c(100,800,1,1,50,10,10,20))
