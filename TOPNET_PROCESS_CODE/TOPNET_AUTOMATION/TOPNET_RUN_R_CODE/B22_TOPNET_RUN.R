...
origindir <- c("E:/USU_Research_work/TOPNET PROJECT/MODEL COMPARISON/B22_Watershed/B22_WD")
targetdir <- c("E:/USU_Research_work/TOPNET PROJECT/MODEL COMPARISON/B22_Watershed/B22_TOPNETRUN")
...
origindir <- c("E:/USU_Research_work/TOPNET PROJECT/MODEL COMPARISON/B22_Watershed/B22_SD")
...
origindir <- c("E:/USU_Research_work/TOPNET PROJECT/MODEL COMPARISON/B22_Watershed/B22_CD/B22_CD_Daymet")
#targetdir <- c("E:/USU_Research_work/TOPNET PROJECT/INPUT_AUTOMATION/LittleBearRiverDEMO/DEMO_test_1/TOPNET_RUN")
...
setwd("E:/USU_Research_work/TOPNET PROJECT/MODEL COMPARISON/B22_Watershed/B22_TOPNETRUN")
...
calibration=function(x){
  ...
  time_all= seq(as.Date("2007/1/1"), as.Date("2012/12/31"), "day") #create time series
