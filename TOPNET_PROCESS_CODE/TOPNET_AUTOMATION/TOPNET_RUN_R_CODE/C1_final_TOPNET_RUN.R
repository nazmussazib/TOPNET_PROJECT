...
setwd("E:/USU_Research_work/TOPNET PROJECT/MODEL COMPARISON/C1_Watershed_final/C1_TOPNETRUN")
setwd("E:\\C1_Watershed_final\\C1_TOPNETRUN")
...
lines(rep(time_c[1461],451)  ,seq(0,450,1),col="grey60",lty=2)
...
text(time_c[1100],420, "C1",cex = 2)
#text(time_c[150],610, "Calibration",cex = 1.25)
text(time_c[400],400, paste("Bias=",format(Bias_c,digit=2)),cex = 1.25)
text(time_c[400],370, paste("NSE=",format(CE_c,digit=2)),cex = 1.25)
text(time_c[1950],400, paste("Bias=",format(Bias_v,digit=2)),cex = 1.25)
text(time_c[1950],370, paste("NSE=",format(CE_v,digit=2)),cex = 1.25)
...
text(15100,500, paste("Bias=",format(Bias_v,digit=2)),cex = 1.25)
text(15100,460, paste("NSE=",format(CE_v,digit=2)),cex = 1.25)
text(15100,420, paste("MSE=",format(Mean_error_v,digit=2)),cex =1.25)
...
plot(time, calibrated_flow$simu, axes=T, ylim=c(0,800), xlab="", ylab="",type="l",lty=1,col="red", main="")
points(time, calibrated_flow$simu,pch=20,col="red")
axis(2, ylim=c(0,30),col="red",lwd=2)
mtext(2,text="Stream flow(m3/s)",line=2)

par(new=T)
plot(time, calibrated_flow$observ, axes=T, ylim=c(0,800), xlab="", ylab="",type="l",lty=2,col="blue", main="")
points(time, calibrated_flow$observ,pch=20,col="blue")
axis(2, ylim=c(0,600),col="blue",lwd=2)
#mtext(2,text="NSE",line=2)

par(new=T)
plot(time, simu_rain[732:1827,], axes=F, ylim=rev(c(0,250)), col="darkgrey",xlab="", ylab="", type="l",lty=3, main="",lwd=2)
...
legend(15270,10000,legend=c("Observed flow","Simulatedflow"),lty=c(1,2),col=c("blue","red"))
