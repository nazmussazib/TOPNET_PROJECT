...
origindir <- c("E:/USU_Research_work/TOPNET PROJECT/MODEL COMPARISON/A1_watershed_2nd/A1_WD")
targetdir <- c("E:/USU_Research_work/TOPNET PROJECT/MODEL COMPARISON/A1_watershed_2nd/A1_TOPNETRUN")
...
origindir <- c("E:/USU_Research_work/TOPNET PROJECT/MODEL COMPARISON/A1_watershed_2nd/A1_SD")
...
origindir <- c("E:/USU_Research_work/TOPNET PROJECT/MODEL COMPARISON/A1_watershed_2nd/A1_CD")
#targetdir <- c("E:/USU_Research_work/TOPNET PROJECT/INPUT_AUTOMATION/LittleBearRiverDEMO/DEMO_test_1/TOPNET_RUN")
...
lines(rep(time_c[1461],36)  ,seq(0,35,1),col="grey60",lty=2)
...
text(time_c[1300],30, "A1",cex = 2)
text(time_c[150],25, "Calibration",cex = 1.25)
text(time_c[150],22, paste("Bias=",format(Bias_c,digit=2)),cex = 1.25)
text(time_c[150],19, paste("NSE=",format(CE_c,digit=2)),cex = 1.25)
text(time_c[1650],25,"Validation",cex = 1.25)
text(time_c[1650],22, paste("Bias=",format(Bias_v,digit=2)),cex = 1.25)
text(time_c[1650],19, paste("NSE=",format(CE_v,digit=2)),cex = 1.25)
...
##validation plot###
setwd("F:\\USU_Research_work_update_March_30_2014\\TOPNET PROJECT\\MODEL COMPARISON\\A1_watershed_final\\A1_TOPNETRUN")
system(paste("topnet_modified"))
ff=scan("FlowAtStreamNodes_cms.txt", what="")
#l=basin_number+2
l=29+2
