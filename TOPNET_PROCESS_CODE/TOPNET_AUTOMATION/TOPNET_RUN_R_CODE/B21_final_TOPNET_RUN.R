...
setwd("E:\\USU_Research_work\\TOPNET PROJECT\\MODEL COMPARISON\\B21_watershed_final\\B21_TOPNETRUN - Copy")
setwd("C:\\B21_watershed_final\\B21_TOPNETRUN")
...
lines(rep(time_c[1461],251)  ,seq(0,250,1),col="grey60",lty=2)
...
text(time_c[1100],200, "B21",cex = 2)
#text(time_c[150],610, "Calibration",cex = 1.25)
text(time_c[400],200, paste("Bias=",format(Bias_c,digit=2)),cex = 1.25)
text(time_c[400],180, paste("NSE=",format(CE_c,digit=2)),cex = 1.25)
text(time_c[1950],200, paste("Bias=",format(Bias_v,digit=2)),cex = 1.25)
text(time_c[1950],180, paste("NSE=",format(CE_v,digit=2)),cex = 1.25)
...
plot(time_c,cumsum(0.63*cv_flow$observ[1:1096]),col='blue',ylab="cumulative flow (mm)")
lines(time_c,cumsum(0.63*cv_flow$simu[1:1096]),col='red')

plot(time_c,cumsum(simu_rain[732:1827]),ylab="cumulative rainfall/flow (mm)")
lines(time_c,cumsum(0.63*cv_flow$observ[1:1096]),col='blue',ylab="cumulative flow (mm)")
lines(time_c,cumsum(0.63*cv_flow$simu[1:1096]),col='red')
legend(14650,1500, c("rainfall","observed flow","simulated flow"), cex=0.8, col=c("black","blue","red"), pch=21, lty=1);
...
text(15400,19, paste("Bias=",format(Bias_v,digit=2)),cex = 1.25)
text(15400,17, paste("NSE=",format(CE_v,digit=2)),cex = 1.25)
text(15400,15, paste("MSE=",format(Mean_error_v,digit=2)),cex =1.25)
...
plot(time_cv,cumsum(0.63*cv_flow$observ),col='blue',ylab="cumulative flow (mm)")
lines(time_cv,cumsum(0.63*cv_flow$simu),col='red')




plot(time_cv,cumsum(simu_rain),ylab="cumulative rainfall/flow (mm)")
lines(time_cv,cumsum(0.63*cv_flow$observ),col='blue',ylab="cumulative flow (mm)")
lines(time_cv,cumsum(0.63*cv_flow$simu),col='red')
...
par(new=T)
plot(time, simu_rain[732:1827,], axes=F, ylim=rev(c(0,150)), col="darkgrey",xlab="", ylab="", type="l",lty=3, main="",lwd=2)
