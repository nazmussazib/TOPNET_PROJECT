...
origindir <- c("E:/USU_Research_work/TOPNET PROJECT/MODEL COMPARISON/test_B1_third_6353000/B1_th_WD")
targetdir <- c("E:/USU_Research_work/TOPNET PROJECT/MODEL COMPARISON/test_B1_third_6353000/B1_th_TOPNETRUN")
...
origindir <- c("E:/USU_Research_work/TOPNET PROJECT/MODEL COMPARISON/test_B1_third_6353000/B1_th_SD")
...
origindir <- c("E:/USU_Research_work/TOPNET PROJECT/MODEL COMPARISON/test_B1_third_6353000/B1_th_CD/B1_th_CD_present/B1_th_CD_Daymet")
#targetdir <- c("E:/USU_Research_work/TOPNET PROJECT/INPUT_AUTOMATION/LittleBearRiverDEMO/DEMO_test_1/TOPNET_RUN")
...
setwd("E:/USU_Research_work/TOPNET PROJECT/MODEL COMPARISON/test_B1_third_6353000/B1_th_TOPNETRUN")
...
library(hydroPSO)
xe1=(c(0.01,0.1,0.5,0.6,1,1,0.1))
xe2=(c(500,1000,1,1,500,50,15))
