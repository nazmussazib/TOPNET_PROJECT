...
par(mfrow=c(2,2))
##plotting Qmean
plot(df$Qmean_whole[ob],df$Qmean_whole[ca], main="Mean", xlab="observed", ylab="calibrated", pch=19,cex.lab=1.5,cex.axis=1.5,cex.main=1.5,cex.sub=1.5)
h1=NSE(df$Qmean_whole[ca],df$Qmean_whole[ob])
legend("topleft", bty="n", legend=paste("NSE is",format(h1, digits=2)),cex=1.5, pch=19)
##plotting q7max
plot(df$Q7max[ob],df$Q7max[ca], main="Q7max",xlab="observed", ylab="calibrated", pch=19,cex.lab=1.5,cex.axis=1.5,cex.main=1.5,cex.sub=1.5)
h2=NSE(df$Q7max[ca],df$Q7max[ob])
legend("topleft", bty="n", legend=paste("NSE is",format(h2, digits=2)),cex=1.5, pch=19)
##plotting Q7min
plot(df$Q7min[ob],df$Q7min[ca], main="Q7min", xlab="observed", ylab="calibrated", pch=19,cex.lab=1.5,cex.axis=1.5,cex.main=1.5,cex.sub=1.5)
h3=NSE(df$Q7min[ca],df$Q7min[ob])
legend("topleft", bty="n", legend=paste("NSE is",format(h3, digits=2)),cex=1.5, pch=19)
##plotting q167
plot(df$BFF_Ln[ob],df$BFF_Ln[ca], main="Q167",xlab="observed", ylab="calibrated", pch=19,cex.lab=1.5,cex.axis=1.5,cex.main=1.5,cex.sub=1.5)
h4=NSE(df$BFF_Ln[ca],df$BFF_Ln[ob])
legend("topleft", bty="n", legend=paste("NSE is",format(h4, digits=2)),cex=1.5, pch=19)

par(mfrow=c(2,2))
##plotting T50
plot(df$T50[ob],df$T50[ca], main="T50",xlab="observed", ylab="calibrated", pch=19,cex.lab=1.5,cex.axis=1.5,cex.main=1.5,cex.sub=1.5)
h7=NSE(df$T50[ca],df$T50[ob])
legend("topleft", bty="n", legend=paste("NSE is",format(h7, digits=2)),cex=1.5, pch=19)
##plotting Peaktime
plot(df$Pk_time[ob],df$Pk_time[ca], main="Tp", xlab="observed", ylab="calibrated", pch=19,cex.lab=1.5,cex.axis=1.5,cex.main=1.5,cex.sub=1.5)
h8=NSE(df$Pk_time[ca],df$Pk_time[ob])
legend("topleft", bty="n", legend=paste("NSE is",format(h8, digits=2)),cex=1.5, pch=19)
##plotting FLDDUR
plot(df$FD_Ln[ob],df$FD_Ln[ca], main="FLDDUR",xlab="observed", ylab="calibrated", pch=19,cex.lab=1.5,cex.axis=1.5,cex.main=1.5,cex.sub=1.5)
h5=NSE(df$FD_Ln[ca],df$FD_Ln[ob])
legend("topleft", bty="n", legend=paste("NSE is",format(h5, digits=2)),cex=1.5, pch=19)
##plotting FR
plot(df$FR[ob],df$FR[ca], main="FR", xlab="observed", ylab="calibrated", pch=19,cex.lab=1.5,cex.axis=1.5,cex.main=1.5,cex.sub=1.5)
h6=NSE(df$FR[ca],df$FR[ob])
legend("topleft", bty="n", legend=paste("NSE is",format(h6, digits=2)),cex=1.5, pch=19)
...
##plotting HFE
plot(df$HFE[ob],df$HFE[ca], main="HFE", xlab="observed", ylab="calibrated", pch=19,cex.lab=1.5,cex.axis=1.5,cex.main=1.5,cex.sub=1.5)
h10=NSE(df$HFE[ca],df$HFE[ob])
legend("topleft", bty="n", legend=paste("NSE is",format(h10, digits=2)),cex=1.5, pch=19)
##plotting LFE
plot(df$LFE[ob],df$LFE[ca], main="LFE",xlab="observed", ylab="calibrated",pch=19,cex.lab=1.5,cex.axis=1.5,cex.main=1.5,cex.sub=1.5)
h9=NSE(df$LFE[ca],df$LFE[ob])
legend("topleft", bty="n", legend=paste("NSE is",format(h9, digits=2)),cex=1.5, pch=19)
##plotting ZFE
plot(df$ZFE[ob],df$ZFE[ca], main="ZFE", xlab="observed", ylab="calibrated", pch=19,cex.lab=1.5,cex.axis=1.5,cex.main=1.5,cex.sub=1.5)
h11=NSE(df$ZFE[ca],df$ZFE[ob])
legend("topleft", bty="n", legend=paste("NSE is",format(h11, digits=2)),cex=1.5, pch=19)
##plotting SI
plot(df$SI[ob],df$SI[ca], main="SI", xlab="observed", ylab="calibrated", pch=19,cex.lab=1.5,cex.axis=1.5,cex.main=1.5,cex.sub=1.5)
h12=NSE(df$SI[ca],df$SI[ob])
legend("topleft", bty="n", legend=paste("NSE is",format(h12, digits=2)),cex=1.5, pch=19)

par(mfrow=c(2,2))
##plotting M
plot(df$M[ob],df$M[ca], main="M", xlab="", ylab="", pch=19,cex.lab=1.5,cex.axis=1.5,cex.main=1.5,cex.sub=1.5)
h15=NSE(df$M[ca],df$M[ob])
legend("topleft", bty="n", legend=paste("NSE is",format(h15, digits=2)),cex=1.5, pch=19)
##plotting COV
plot(df$CoV_whole[ob],df$CoV_whole[ca], main="COV", xlab="", ylab="", pch=19,cex.lab=1.5,cex.axis=1.5,cex.main=1.5,cex.sub=1.5)
h16=NSE(df$CoV_whole[ca],df$CoV_whole[ob])
legend("topleft", bty="n", legend=paste("NSE is",format(h16, digits=2)),cex=1.5, pch=19)
##plotting p
plot(df$P[ob],df$P[ca], main="P", xlab=" observed", ylab=" ", pch=19,cex.lab=1.5,cex.axis=1.5,cex.main=1.5,cex.sub=1.5)
h13=NSE(df$P[ca],df$P[ob])
legend("topleft", bty="n", legend=paste("NSE is",format(h13, digits=2)),cex=1.5, pch=19)

##plotting c
plot(df$C[ob],df$C[ca], main="C", xlab="observed  ", ylab="", pch=19,cex.lab=1.5,cex.axis=1.5,cex.main=1.5,cex.sub=1.5)
h14=NSE(df$C[ca],df$C[ob])
legend("topleft", bty="n", legend=paste("NSE is",format(h14, digits=2)),cex=1.5, pch=19)
