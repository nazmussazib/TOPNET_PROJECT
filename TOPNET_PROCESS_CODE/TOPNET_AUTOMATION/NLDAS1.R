...
library(zoo)
library(plyr)
setwd("E:/USU_Research_work/GIS") # set working directory
bbox=c(37.27,-118.95,37.4,-118.8) # boundary box of the study area
start_time="2000-01-01 00:00" # start time
...
y=data.frame(xe=c(1,2,3,4,5,6))


df2 <- ddply( y,'xe',rain)
library(rgdal)
ribfile<-"NLDAS_FOR0125_H.A20000101.0000.001.grb"
grib <- readGDAL(ribfile)
