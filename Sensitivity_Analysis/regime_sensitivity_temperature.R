...
regime_change=function(delT){
  
#regime_change=function(delP,delT) 

dir=("E:\\USU_Research_work\\SENSITIVITY_PROJECT\\C22_TOPNETRUN")
setwd(dir)
...
####please change basin number before applying 

##A2=113,B1=25,C1=131,B21=135,B22=43,C21=59,C22=43
...
a=seq(-2,6,1)
results=sapply(a,regime_change)
write.table(results,"C22_temperature_sensitivity.txt")
...
ra=results
ra=(ra/ra[,5])-1
r=matrix(ra,nrow=144,ncol=1)
r[is.na(r)]=0
variables=matrix(rep(names,9))
ab=a
scena1=data.frame(x=rep(ab,each=16))
