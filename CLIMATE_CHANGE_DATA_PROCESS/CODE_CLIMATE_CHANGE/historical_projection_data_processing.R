...
pr.nc = nc_open(paste("BCCA_0.125deg_tasmax_day_",Model,"_rcp26_r5i1p1_20460101-20551231.nc",sep=""))
...
proj_rain1=cbind(proj_dff1,precp_rcp_all[1:7305,1:len]) ##rcp2.6 45
proj_rain2=cbind(proj_dff1,precp_rcp_all[1:7305,(len+1):(len*2)])  ##rcp8.5 45
proj_rain3=cbind(proj_dff2,precp_rcp_all[7306:14610,1:len]) ##rcp 2.6 76
proj_rain4=cbind(proj_dff2,precp_rcp_all[7306:14610,(len+1):(len*2)]) ##rcp 8.5 76

proj_tmax1=cbind(proj_dff1,tmax_rcp_all[1:7305,1:len]) ##rcp2.6 45
proj_tmax2=cbind(proj_dff1,tmax_rcp_all[1:7305,(len+1):(len*2)])  ##rcp8.5 45
proj_tmax3=cbind(proj_dff2,tmax_rcp_all[7306:14610,1:len]) ##rcp 2.6 76
proj_tmax4=cbind(proj_dff2,tmax_rcp_all[7306:14610,(len+1):(len*2)]) ##rcp 8.5 76

proj_tmin1=cbind(proj_dff1,tmin_rcp_all[1:7305,1:len]) ##rcp2.6 45
proj_tmin2=cbind(proj_dff1,tmin_rcp_all[1:7305,(len+1):(len*2)])  ##rcp8.5 45
proj_tmin3=cbind(proj_dff2,tmin_rcp_all[7306:14610,1:len]) ##rcp 2.6 76
proj_tmin4=cbind(proj_dff2,tmin_rcp_all[7306:14610,(len+1):(len*2)]) ##rcp 8.5 76
...
for(i in 1:(len)){
  ...
  for ( j in 1:365){
    ...
    id_proj1=which(proj_dff1[,2]==dym[j,1] & proj_dff1[,3]==dym[j,2])
    id_proj2=which(proj_dff2[,2]==dym[j,1] & proj_dff2[,3]==dym[j,2])
    
    obs=rainobs[id_his,i]
    sim=rainsim[id_his,i]
    proj1=proj_rain1[id_proj1,i+3]
    proj2=proj_rain2[id_proj1,i+3]
    proj3=proj_rain3[id_proj2,i+3]
    proj4=proj_rain4[id_proj2,i+3]
    
    rain_qm.fit <- fitQmapRQUANT(obs,sim,qstep=0.1,nboot=1,wet.day=0)
    his_corr <- doQmapRQUANT(sim,rain_qm.fit,type="tricub")
    
    
    rain_qm.fit1 <- fitQmapRQUANT(sim,proj1,qstep=0.1,nboot=1,wet.day=0)
    rain_qm.fit11 <- fitQmapRQUANT(obs,proj1,qstep=0.1,nboot=1,wet.day=0)
    proj_corr1 <- doQmapRQUANT( proj1,rain_qm.fit1,type="tricub")
    proj_corr2 <- doQmapRQUANT(proj1,rain_qm.fit11,type="tricub")
    d1= proj_corr2-proj_corr1;
    
    rain_qm.fit2 <- fitQmapRQUANT(sim,proj2,qstep=0.1,nboot=1,wet.day=0)
    rain_qm.fit22 <- fitQmapRQUANT(obs,proj2,qstep=0.1,nboot=1,wet.day=0)
    proj_corr3 <- doQmapRQUANT( proj2,rain_qm.fit2,type="tricub")
    proj_corr4 <- doQmapRQUANT(proj2,rain_qm.fit22,type="tricub")
    d2= proj_corr4-proj_corr3;
    
    rain_qm.fit3 <- fitQmapRQUANT(sim,proj3,qstep=0.1,nboot=1,wet.day=0)
    rain_qm.fit33 <- fitQmapRQUANT(obs,proj3,qstep=0.1,nboot=1,wet.day=0)
    proj_corr5 <- doQmapRQUANT( proj3,rain_qm.fit3,type="tricub")
    proj_corr6 <- doQmapRQUANT(proj3,rain_qm.fit33,type="tricub")
    d3= proj_corr6-proj_corr5;
    
    rain_qm.fit4 <- fitQmapRQUANT(sim,proj4,qstep=0.1,nboot=1,wet.day=0)
    rain_qm.fit44 <- fitQmapRQUANT(obs,proj4,qstep=0.1,nboot=1,wet.day=0)
    proj_corr7 <- doQmapRQUANT(proj4,rain_qm.fit4,type="tricub")
    proj_corr8 <- doQmapRQUANT(proj4,rain_qm.fit44,type="tricub")
    d4= proj_corr8-proj_corr7;
    
    rainsim[id_his,i]= his_corr
    proj_rain1[id_proj1,i+3]=proj_rain1[id_proj1,i+3]+d1
    proj_rain2[id_proj1,i+3]=proj_rain2[id_proj1,i+3]+d2
    proj_rain3[id_proj2,i+3]=proj_rain3[id_proj1,i+3]+d3
    proj_rain4[id_proj2,i+3]=proj_rain4[id_proj1,i+3]+d4
...
proj_rain1[proj_rain1<0]=a[proj_rain1<0]
proj_rain2[proj_rain2<0]=b[proj_rain2<0]
proj_rain3[proj_rain3<0]=c[proj_rain3<0]
proj_rain4[proj_rain4<0]=d[proj_rain4<0]
...
for(i in 1:(len)){
  ...
  for ( j in 1:12){
    ...
    obs=sort(tmaxobs[id_his,i])
    sim=sort(tmaxsim[id_his,i])
    proj1=sort(proj_tmax1[id_proj1,i+3])
    proj2=sort(proj_tmax2[id_proj1,i+3])
    proj3=sort(proj_tmax3[id_proj2,i+3])
    proj4=sort(proj_tmax4[id_proj2,i+3])
    
    tmax_qm.fit <- fitQmapRQUANT(obs,sim,qstep=0.1,nboot=1,wet.day=FALSE)
    his_corr <- doQmapRQUANT(tmaxsim[id_his,i],tmax_qm.fit,type="tricub")
    
    
    tmax_qm.fit1 <- fitQmapRQUANT(sim,proj1,qstep=0.1,nboot=1,wet.day=FALSE)
    tmax_qm.fit11 <- fitQmapRQUANT(obs,proj1,qstep=0.1,nboot=1,wet.day=FALSE)
    proj_corr1 <- doQmapRQUANT(proj_tmax1[id_proj1,i+3],tmax_qm.fit1,type="tricub")
    proj_corr2 <- doQmapRQUANT(proj_tmax1[id_proj1,i+3],tmax_qm.fit,type="tricub")
    
    
    tmax_qm.fit2 <- fitQmapRQUANT(sim,proj2,qstep=0.1,nboot=1,wet.day=FALSE)
    tmax_qm.fit22 <- fitQmapRQUANT(obs,proj2,qstep=0.1,nboot=1,wet.day=FALSE)
    proj_corr3 <- doQmapRQUANT(proj_tmax2[id_proj1,i+3],tmax_qm.fit2,type="tricub")
    proj_corr4 <- doQmapRQUANT(proj_tmax2[id_proj1,i+3],tmax_qm.fit22,type="tricub")
    
    tmax_qm.fit3 <- fitQmapRQUANT(sim,proj3,qstep=0.1,nboot=1,wet.day=FALSE)
    tmax_qm.fit33 <- fitQmapRQUANT(obs,proj3,qstep=0.1,nboot=1,wet.day=FALSE)
    proj_corr5 <- doQmapRQUANT(proj_tmax3[id_proj2,i+3],tmax_qm.fit3,type="tricub")
    proj_corr6 <- doQmapRQUANT(proj_tmax3[id_proj2,i+3],tmax_qm.fit33,type="tricub")
    
    tmax_qm.fit4 <- fitQmapRQUANT(sim,proj4,qstep=0.1,nboot=1,wet.day=FALSE)
    tmax_qm.fit44 <- fitQmapRQUANT(obs,proj4,qstep=0.1,nboot=1,wet.day=FALSE)
    proj_corr7 <- doQmapRQUANT(proj_tmax4[id_proj2,i+3],tmax_qm.fit4,type="tricub")
    proj_corr8 <- doQmapRQUANT(proj_tmax4[id_proj2,i+3],tmax_qm.fit44,type="tricub")
    
    obsdr=sort(dtrobs[id_his,i])
    simdr=sort(dtrsim[id_his,i])
    proj1dr=sort(proj_dtr1[id_proj1,i+3])
    proj2dr=sort(proj_dtr2[id_proj1,i+3])
    proj3dr=sort(proj_dtr3[id_proj2,i+3])
    proj4dr=sort(proj_dtr4[id_proj2,i+3])
    
    dtr_qm.fit <- fitQmapRQUANT(obsdr,simdr,qstep=0.1,nboot=1,wet.day=0)
    his_corrdr <- doQmapRQUANT(dtrsim[id_his,i],dtr_qm.fit,type="tricub")
    
    
    dtr_qm.fit1 <- fitQmapRQUANT(simdr,proj1dr,qstep=0.1,nboot=1,wet.day=0)
    dtr_qm.fit11 <- fitQmapRQUANT(obsdr,proj1dr,qstep=0.1,nboot=1,wet.day=0)
    proj_corr1dr <- doQmapRQUANT(proj_dtr1[id_proj1,i+3],dtr_qm.fit1,type="tricub")
    proj_corr2dr <- doQmapRQUANT(proj_dtr1[id_proj1,i+3],dtr_qm.fit,type="tricub")
    
    
    dtr_qm.fit2 <- fitQmapRQUANT(simdr,proj2dr,qstep=0.1,nboot=1,wet.day=0)
    dtr_qm.fit22 <- fitQmapRQUANT(obsdr,proj2dr,qstep=0.1,nboot=1,wet.day=0)
    proj_corr3dr <- doQmapRQUANT(proj_dtr2[id_proj1,i+3],dtr_qm.fit2,type="tricub")
    proj_corr4dr <- doQmapRQUANT(proj_dtr2[id_proj1,i+3],dtr_qm.fit22,type="tricub")
    
    dtr_qm.fit3 <- fitQmapRQUANT(simdr,proj3dr,qstep=0.1,nboot=1,wet.day=0)
    dtr_qm.fit33 <- fitQmapRQUANT(obsdr,proj3dr,qstep=0.1,nboot=1,wet.day=0)
    proj_corr5dr <- doQmapRQUANT(proj_dtr3[id_proj2,i+3],dtr_qm.fit3,type="tricub")
    proj_corr6dr <- doQmapRQUANT(proj_dtr3[id_proj2,i+3],dtr_qm.fit33,type="tricub")
    
    dtr_qm.fit4 <- fitQmapRQUANT(simdr,proj4dr,qstep=0.1,nboot=1,wet.day=0)
    dtr_qm.fit44 <- fitQmapRQUANT(obsdr,proj4dr,qstep=0.1,nboot=1,wet.day=0)
    proj_corr7dr <- doQmapRQUANT(proj_dtr4[id_proj2,i+3],dtr_qm.fit4,type="tricub")
    proj_corr8dr <- doQmapRQUANT(proj_dtr4[id_proj2,i+3],dtr_qm.fit44,type="tricub")
    ...
    proj_tmax2[id_proj1,i+3]=proj_tmax2[id_proj1,i+3]+proj_corr4-proj_corr3
    proj_tmax3[id_proj2,i+3]=proj_tmax3[id_proj2,i+3]+proj_corr6-proj_corr5
    proj_tmax4[id_proj2,i+3]=proj_tmax4[id_proj2,i+3]+proj_corr8-proj_corr7
    proj_dtr1[id_proj1,i+3]= proj_corr2dr
    proj_dtr2[id_proj1,i+3]=proj_dtr2[id_proj1,i+3]+proj_corr4dr-proj_corr3dr
    proj_dtr3[id_proj2,i+3]= proj_dtr3[id_proj2,i+3]+proj_corr6dr-proj_corr5dr
    proj_dtr4[id_proj2,i+3]=proj_dtr4[id_proj2,i+3]+proj_corr8dr-proj_corr7dr
...
wind <- function(file ){
  ...
  w.nc = nc_open(file)
  w_time=as.Date(ncvar_get(w.nc,'time'),origin="1860-01-01")
