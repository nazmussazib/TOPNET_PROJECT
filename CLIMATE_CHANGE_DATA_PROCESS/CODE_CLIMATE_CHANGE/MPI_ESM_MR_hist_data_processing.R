...
pr.nc = nc_open("BCCA_0.125deg_tasmax_day_MPI-ESM-MR_historical_r3i1p1_19800101-19891231.nc")
...
spl_mod_his=data.frame(slp[,1]/100) ##100 for pa to mb
huss_mod_his=data.frame(shumd[,1])
...
##finding leap year
# dates_win=seq(as.Date("1850/1/1"), as.Date("2005/12/31"), "day") 
...
all_wind=data.frame(wind=ws[-1,1])
